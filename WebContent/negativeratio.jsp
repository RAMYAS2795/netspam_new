...
<a href="#" onclick="window.open('nr.jsp?id=sajid', 'newwindow', 'width=950, height=500'); return false;"><img align="right" src="images/more.png" width="99" height="66" border="0" alt=""></a> 

<u>NegativeRatio UB-NR
</u><hr></h3>
              ...
              <tbody>
                <tr>
                  ...
                  <td><%=rs.getString("userid")%></td>
					<td><%double d1=NegativeRatio.score(rs.getString("userid"),rs.getString("prodid"),tab);
					out.println(d1);
					%>
